-- ao criar um aqrquivo "data.sql' na pasta "resources"
-- caso a configuração "spring.jpa.defer-datasource-initialization" estiver true
-- todas as instruções aqui serão execultadas
-- PODEM haver mais de 1 insert, poré devem sempre terminar com ";"
...
(false, '875638274', '2020-09-09', 'aaaa@bbb', 'xuxu', 2.5, '9999-9999');