...
import sptech.projetojpa05.resposta.AnimalSimplesResposta;
...
public interface AnimalEstimacaoRepository
    ...
    @Query("select new sptech.projetojpa05.resposta.AnimalSimplesResposta(a.codigo, a.nome, a.tipo.descricao) from AnimalEstimacao a where a.nome like ?1")
    List<AnimalSimplesResposta> listaSimples(String nomeAnimal);
